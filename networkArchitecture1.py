...
class FeedForwardNet(nn.Module):
    ...
    def __init__(self, inpNum, shape, classesNum):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(inpNum, 16, 3, 1,2), nn.BatchNorm2d(16), nn.ReLU(), nn.MaxPool2d(kernel_size=2))
        ...
        self.conv4 = nn.Sequential(
            nn.Conv2d(64, 128, 3, 1,2), nn.BatchNorm2d(128), nn.ReLU(), nn.MaxPool2d(kernel_size=2))
